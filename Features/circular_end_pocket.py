...
class CircularEndPocket(MachiningFeature):
    ...
    def _add_sketch(self, bound, hetero):
        ...
        if hetero:
            ...
            radius_dir1 = occ_utils.rotate_vector(dir_w, angle1, normal)
            radius_dir2 = occ_utils.rotate_vector(dir_w, angle2, normal)
            pt01 = occ_utils.as_occ(c01 - radius_dir1 * radius, gp_Pnt)
            pt23 = occ_utils.as_occ(c23 + radius_dir2 * radius, gp_Pnt)
            ...
            seg_maker = [GC_MakeArcOfCircle(cir01, pt0, pt01, True), GC_MakeArcOfCircle(cir01, pt01, pt1, True),
                         GC_MakeSegment(pt1, pt2), GC_MakeArcOfCircle(cir23, pt2, pt23, True),
                         GC_MakeArcOfCircle(cir23, pt23, pt3, True), GC_MakeSegment(pt3, pt0)]
