...
class VCircularEndBlindSlot(MachiningFeature):
    ...
    def _add_sketch(self, bound, hetero):
        ...
        if hetero:
            ...
            radius_dir = occ_utils.rotate_vector(dir_h, angle, occ_utils.as_occ(normal, gp_Dir))
            pt34 = occ_utils.as_occ(center + radius_dir * radius, gp_Pnt)
            ...
            seg_maker = [GC_MakeSegment(pt1, pt2), GC_MakeSegment(pt2, pt3), GC_MakeArcOfCircle(circ, pt3, pt34, True),
                         GC_MakeArcOfCircle(circ, pt34, pt4, True), GC_MakeSegment(pt4, pt1)]
