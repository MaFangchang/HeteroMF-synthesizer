...
def list_wire_combo(num_cell, ang, offset, radius):
    ...
    input
       ...
       ang:             float, angle between adjacent cells
...
def map_from_shape_and_name(fmap, old_labels, new_shape, new_name, feature_dir=None):
    ...
    for n_face in new_faces:
        ...
        # determine machining feature fead direction
        # the normal vector of bottom face is parallel to the machining fead direction
        if feature_dir:
